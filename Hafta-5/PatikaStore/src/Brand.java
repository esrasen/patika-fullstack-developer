...
public class Brand implements Comparable<Brand> {
    ...
    //Marka ismine göre listelemek için
    @Override
    public int compareTo(Brand o) {
      return this.name.compareTo(o.getName());
    }

    //Markaları listelemek için
    ...
    public static boolean isValidBrand(String brand) {      //Brand sınıfı içerisindeki brands() metodu ile girilen markanın geçerli olup olmadığını kontrol ediyoruz.
